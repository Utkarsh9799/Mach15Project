...
export default function Card(){
        return(
            <div className='row'>
                <div className='col-md-3 col-xs-12' style={{marginTop:'5%'}}>
                    <div className="card" style={{width:'15rem',borderRadius:'5%',alignItems:'center',backgroundColor:'#E5E4E2'}}>
                        ...
                        <div className="card-body" style={{width:'100%',fontSize:'12px',padding:'2px',textAlign:'center',margin:'0px'}}>
                            <div className="row" style={{width:'100%',marginTop:'2%'}}>
                                <h5 className="col-md-8 card-title" style={{fontSize:'17px',fontWeight:'bolder'}}>The Local Train</h5>
                                <p className="col-md-4" style={{alignItems:'left',fontSize:'15px'}}><img src={require('../../../assets/bluetick.png')} alt="ble tick" style={{width:'20px',height:'20px'}} />
                                <span className="fa fa-heart-o" style={{paddingLeft:'10px'}}></span></p>
                            </div>
                            <p className="card-text" style={{fontSize:'12px',padding:'0px'}}>INDIAN ROCK • INDIE ROCK</p>
                            ...
                            <div className='row'style={{textAlign:'center',paddingTop:'8px',fontSize:'10px',fontWeight:'bold'}}>
                                <p className='col'><i className="fa fa-comment-alt"></i>Chat with Us</p>
                                <p className='col'><i className="fa fa-envelope"></i>Email Us</p>
                            </div>
